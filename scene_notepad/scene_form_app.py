...
from scene_notepad.entity import Entity
from scene_notepad.scene import Scene

class SceneFormApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Scene Form")
        self.file_path = r"C:\atari-monk\code\text-data\scene_notepad\scenes.json"
        self.config_path = r"C:\atari-monk\code\text-data\scene_notepad\sceneForm.json"
